...
chmod +x "$install_root/context-guardian" "$install_root/context-image-gateway" "$install_root/context-guardian-mcp.mjs" "$install_root/service.sh"
...
printf '%s\n' "Installed CLI: $bin_dir/context-guardian" "Installed gateway: $bin_dir/context-image-gateway" "Installed MCP: $bin_dir/context-guardian-mcp" "Add $bin_dir to PATH if needed."
